...
| [Models folder](models)                      | Folder where the model trained with the **[01 Sentiment Analysis Model.ipynb](01%20Sentiment%20Analysis%20Model.ipynb)** file is stored. It can also be found in a zip file in case the folder get corrupted.                       |
